# [Web Application Development](https://gitlab.msu.edu/cse477-fall-2025/course-materials/): Homework 2
...
Deploy your Dockerized App to Google Cloud by running the commands below from the Homework-2 directory. Note that you should replace cse477-fall-2025 with your project ID found at Google Cloud Console.

```bash
gcloud builds submit --tag gcr.io/cse477-fall-2025/homework2
gcloud run deploy --image gcr.io/cse477-fall-2025/homework2 --platform managed
```
...
[Submit the Service URL for your live web application in this Google Form](https://docs.google.com/forms/d/e/1FAIpQLSexErpOXxYhm7FUdlvCXjk6KOA3a8aPinfSP0n2aVoSky5LXA/viewform?usp=dialog)
